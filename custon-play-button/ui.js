...
function updateOutput() {
  ...
  if (sourceEmbedCode && sourceEmbedCode.isValid()) {
    ...
    outputEmbedCode.setOption("plugin.custom-play-button.buttonPosition", $("#button_position").val());
    outputEmbedCode.setOption("plugin.custom-play-button.src", pluginSrc(sourceEmbedCode));
    outputEmbedCode.setOption("playButton", false);
    outputEmbedCode.setOption("endVideoBehavior", "reset");
    outputEmbedCode.setOption("controlsVisibleOnLoad", true);
    outputEmbedCode.setOption("plugin.custom-play-button.buttonUrl", $("#button_location").val());
